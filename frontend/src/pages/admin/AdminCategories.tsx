...
const AdminCategories: React.FC = () => {
    ...
    return (
        <div className="admin-categories-page">
            ...
            <style>{`
                .admin-categories-page { padding: 160px 5% 50px; min-height: 100vh; max-width: 1400px; margin: 0 auto; }
                ...
                @media (max-width: 768px) {
                    .admin-categories-page { padding-top: 120px; }
                    .admin-header { flex-direction: column; gap: 20px; align-items: flex-start; }
                    .admin-header h1 { font-size: 1.8rem; }
                    .add-btn { width: 100%; justify-content: center; }
                    .categories-table-container { overflow-x: auto; -webkit-overflow-scrolling: touch; }
